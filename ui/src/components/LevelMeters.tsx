  ...
  return (
    <div className="level-meters">
      ...
      <div className="meter-track">
        <div className="meter-fill" style={{ width: (levels.l * 100) + '%', background: getLevelColor(levels.l) }} />
      </div>
      <div className="meter-track">
        <div className="meter-fill" style={{ width: (levels.r * 100) + '%', background: getLevelColor(levels.r) }} />
      </div>
