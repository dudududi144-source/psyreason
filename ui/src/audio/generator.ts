...
export function libraryStats() {
  ...
  const T: [string, any[]][] = [
    ...
    ['Layered Re-Entry', [FS('AMBIENT TEXTURE',16,['pad'],'ambient'),FS('BUILD',8,['kick','bass','hats','open','lead'],'build'),FS('DROP',8,['kick','bass','hats'],'drop'),FS('DROP +',16,['kick','bass','hats','open','lead'],'drop'),FS('CLIMAX',16,['kick','bass','hats','open','lead','pad'],'climax'),FS('OUTRO',8,['kick','hats'],'outro')]],
