...
export function buildForms(): SoundPreset[] {
  ...
  const T: [string, any[]][] = [
    ['Classic Full-On Journey', [FS('INTRO',16,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',24,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',24,FULL,'drop2'),FS('CLIMAX',8,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Peak Time Club', [FS('INTRO',8,GROOVE,'intro'),FS('DROP',32,FULL,'drop'),FS('PERC TRIBAL',8,PERC,'perc'),FS('DROP 2',32,FULL,'drop2'),FS('CLIMAX',8,FULL,'climax'),FS('DJ OUTRO',8,MIN,'outro')]],
    ['Progressive Ascent', [FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('ACID BREAK',16,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',16,MIN,'outro')]],
    ['Morning Uplift', [FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',24,FULL,'drop'),FS('HALF-TIME',8,HALF,'half'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',8,AIR,'outro')]],
    ['Dark Hypnotic', [FS('INTRO',16,GROOVE,'intro'),FS('DROP',48,FULL,'drop'),FS('PERC TRIBAL',8,PERC,'perc'),FS('ACID BREAK',8,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',48,FULL,'drop2'),FS('OUTRO',8,MIN,'outro')]],
    ['Radio Edit', [FS('INTRO',8,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',16,FULL,'drop'),FS('BREAK',8,AIR,'break'),FS('RE-ENTRY',4,FULL,'dropin'),FS('DROP 2',16,FULL,'drop2'),FS('OUTRO',4,MIN,'outro')]],
    ['Afterhours Deep', [FS('AMBIENT',16,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('DROP',32,FULL,'drop'),FS('HALF-TIME',8,HALF,'half'),FS('ACID BREAK',8,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',16,AIR,'outro')]],
    ['Double Drop', [FS('INTRO',16,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',16,FULL,'drop'),FS('PERC TRIBAL',8,PERC,'perc'),FS('DROP 2',16,FULL,'drop2'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',24,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ...
    ['Uplifting Anthem', [FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',24,FULL,'drop'),FS('BREAK',24,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',8,AIR,'outro')]],
    ['Forest Ritual', [FS('PERC TRIBAL',16,PERC,'perc'),FS('INTRO',16,GROOVE,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('ACID BREAK',16,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Goa Ceremony', [FS('AMBIENT',16,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',32,FULL,'drop2'),FS('OUTRO',16,AIR,'outro')]],
    ['Psycore Blast', [FS('INTRO',8,GROOVE,'intro'),FS('DROP',24,FULL,'drop'),FS('PERC TRIBAL',8,PERC,'perc'),FS('DROP 2',24,FULL,'drop2'),FS('ACID BREAK',8,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',24,FULL,'climax'),FS('OUTRO',4,MIN,'outro')]],
    ['Chill Descent', [FS('AMBIENT',16,ATMOS,'ambient'),FS('HALF-TIME',16,HALF,'half'),FS('INTRO',16,FULL,'intro'),FS('DROP',24,FULL,'drop'),FS('BREAK',24,AIR,'break'),FS('OUTRO',16,AIR,'outro')]],
    ['Sunrise Set', [FS('AMBIENT',16,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',40,FULL,'climax'),FS('OUTRO',16,AIR,'outro')]],
    ['Warehouse Loop', [FS('INTRO',8,GROOVE,'intro'),FS('DROP',48,GROOVE,'drop'),FS('PERC TRIBAL',16,PERC,'perc'),FS('ACID BREAK',8,ACID,'acid'),FS('RE-ENTRY',8,GROOVE,'dropin'),FS('DROP 2',48,GROOVE,'drop2'),FS('DJ OUTRO',8,MIN,'outro')]],
    ['Melodic Voyage', [FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',24,FULL,'drop2'),FS('CLIMAX',16,FULL,'climax'),FS('OUTRO',16,AIR,'outro')]],
    ['Deep Forest Ritual', [FS('PERC TRIBAL',16,PERC,'perc'),FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('DROP',32,FULL,'drop'),FS('ACID BREAK',16,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Sunrise Anthem Extended', [FS('AMBIENT',16,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',32,FULL,'drop2'),FS('CLIMAX',24,FULL,'climax'),FS('OUTRO',16,AIR,'outro')]],
    ['Minimal Deep Tech', [FS('INTRO',16,MIN,'intro'),FS('DROP',32,GROOVE,'drop'),FS('PERC TRIBAL',8,PERC,'perc'),FS('ACID BREAK',8,ACID,'acid'),FS('RE-ENTRY',8,GROOVE,'dropin'),FS('DROP 2',32,GROOVE,'drop2'),FS('DJ OUTRO',16,MIN,'outro')]],
    ['Twilight Journey', [FS('AMBIENT',16,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('HALF-TIME',8,HALF,'half'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',16,AIR,'outro')]],
    ['Peak Festival', [FS('INTRO',16,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',24,FULL,'drop'),FS('PERC TRIBAL',8,PERC,'perc'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',24,FULL,'drop2'),FS('CLIMAX',16,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Ambient Descent', [FS('AMBIENT',24,ATMOS,'ambient'),FS('HALF-TIME',16,HALF,'half'),FS('INTRO',16,FULL,'intro'),FS('DROP',24,FULL,'drop'),FS('BREAK',24,AIR,'break'),FS('OUTRO',24,AIR,'outro')]],
    ['Goa Sunrise Ceremony', [FS('AMBIENT',16,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('ACID BREAK',16,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',32,FULL,'drop2'),FS('CLIMAX',16,FULL,'climax'),FS('OUTRO',16,AIR,'outro')]],
    ['Tension & Release', [FS('INTRO',8,GROOVE,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',16,FULL,'drop'),FS('BREAK',8,AIR,'break'),FS('RE-ENTRY',4,FULL,'dropin'),FS('DROP 2',16,FULL,'drop2'),FS('BREAK 2',8,AIR,'break'),FS('RE-ENTRY 2',4,FULL,'dropin'),FS('CLIMAX',24,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Layered Re-Entry', [FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',24,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',12,FULL,'dropin'),FS('DROP 2',24,FULL,'drop2'),FS('CLIMAX',8,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Acid Marathon', [FS('INTRO',16,FULL,'intro'),FS('BUILD',4,BUILD,'build'),FS('DROP',32,FULL,'drop'),FS('ACID BREAK',16,ACID,'acid'),FS('RE-ENTRY',8,FULL,'dropin'),FS('DROP 2',32,FULL,'drop2'),FS('ACID BREAK 2',8,ACID,'acid'),FS('CLIMAX',16,FULL,'climax'),FS('OUTRO',8,MIN,'outro')]],
    ['Anthem Re-Entry', [FS('AMBIENT',8,ATMOS,'ambient'),FS('INTRO',16,FULL,'intro'),FS('BUILD',8,BUILD,'build'),FS('DROP',24,FULL,'drop'),FS('BREAK',16,AIR,'break'),FS('RE-ENTRY',12,FULL,'dropin'),FS('CLIMAX',32,FULL,'climax'),FS('OUTRO',8,AIR,'outro')]],
