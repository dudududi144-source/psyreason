...
export function libraryStats() {
  ...
  const T: [string, any[]][] = [
    ...
    ['Tension & Release', [FS('INTRO',8,['kick','bass','hats'],'intro'),FS('BUILD',4,['kick','bass','hats','open','lead'],'build'),FS('DROP',16,['kick','bass','hats','open','lead','pad'],'drop'),FS('BREAK',8,['lead','pad'],'break'),FS('DROP',16,['kick','bass','hats','open','lead','pad'],'drop'),FS('BREAK',8,['lead','pad'],'break'),FS('CLIMAX',24,['kick','bass','hats','open','lead','pad'],'climax'),FS('OUTRO',8,['kick','hats'],'outro')]],
    ...
    ['Sunrise Peak', [FS('AMBIENT TEXTURE',16,['pad'],'ambient'),FS('TEASER',8,['kick','bass','hats','lead'],'intro'),FS('BUILD',8,['kick','bass','hats','open','lead'],'build'),FS('DROP',24,['kick','bass','hats','open','lead','pad'],'drop'),FS('BREAK',16,['lead','pad'],'break'),FS('CLIMAX',48,['kick','bass','hats','open','lead','pad'],'climax'),FS('OUTRO',16,['lead','pad'],'outro')]],
    ['Anthem Re-Entry', [FS('TEASER',8,['kick','bass','hats','lead'],'intro'),FS('BUILD',8,['kick','bass','hats','open','lead'],'build'),FS('DROP',24,['kick','bass','hats','open','lead','pad'],'drop'),FS('BREAK',16,['lead','pad'],'break'),FS('RE-ENTRY',16,['kick','bass','hats','open','lead','pad'],'dropin'),FS('CLIMAX',24,['kick','bass','hats','open','lead','pad'],'climax'),FS('OUTRO',8,['kick','hats'],'outro')]],
    ['Hypnotic Layers', [FS('INTRO',16,['kick','hats'],'intro'),FS('DROPIN',24,['kick','bass','hats','open','lead'],'dropin'),FS('DROP',32,['kick','bass','hats','open','lead','pad'],'drop'),FS('PERC TRIBAL',8,['kick','hats','open'],'perc'),FS('DROPIN',24,['kick','bass','hats','open','lead','pad'],'dropin'),FS('OUTRO',8,['kick','hats'],'outro')]],
    ['Peak Builder', [FS('INTRO',8,['kick','bass','hats'],'intro'),FS('BUILD',4,['kick','bass','hats','open','lead'],'build'),FS('DROPIN',16,['kick','bass','hats','open','lead'],'dropin'),FS('DROP',24,['kick','bass','hats','open','lead','pad'],'drop'),FS('BREAK',16,['lead','pad'],'break'),FS('RE-ENTRY',16,['kick','bass','hats','open','lead','pad'],'dropin'),FS('CLIMAX',24,['kick','bass','hats','open','lead','pad'],'climax'),FS('DJ OUTRO',8,['kick','hats'],'outro')]],
  ];
...
export function composeForm(seed: number) {
  ...
  const FS = (name: string, bars: number, active: string[], role: string) => ({ name, bars, active, role });
  const f: any[] = [];
  f.push(FS('INTRO', 16, FULL, pk(['intro', 'intro_drum']))); // layered build, 2 approaches
